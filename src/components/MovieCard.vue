<template>
    <div
        class="flex items-start py-6 pr-6 ml-6 border-b border-gray-400 md:max-w-3xl md:mx-auto md:pr-0"
    >
        <img
        ...
        <div class="pl-6">
            ...
            <p class="hidden sm:block text-sm mt-4">
                {{ movie.overview }}
            </p>
            <div class="mt-4">
                <span
            ...
            <a
                href="#"
                class="block text-right mt-4 text-xs underline text-indigo-400 hover:text-indigo-300"
                >More Info >></a
            >
        </div>
    </div>
