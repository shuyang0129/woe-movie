<template>
    <div class="fixed inset-0 bg-gray-800 p-6 pb-8 lg:relative">
        <!-- Close -->
        <svg
            class="fill-current text-gray-400 hover:text-gray-200 w-5 h-5 ml-auto"
            viewBox="0 0 20 20"
        >
            <path
        ...
        <!-- Submit & Reset -->
        <button class="w-full btn btn-indigo mt-6 rounded">
            Submit
        </button>
        <button class="w-full btn btn-gray mt-4 rounded">
            Reset
        </button>
    </div>
</template>
